        ...
        >
          ...
          >
            ...
            >
              ...
              <Form
                @submit="(values:any) => emits('submitChangePassord', values)"
...
import type { IChangePasswordPayload } from "@/apis/authApi";
import {
  TransitionRoot,
  TransitionChild,
  Dialog,
...
import { editInputs } from "@/constant";
...
const emits = defineEmits<{
  (e: "submitChangePassord", value: IChangePasswordPayload): void;
}>();
</script>
